const CACHE='rsr-v22-4-cache';
const CORE=['/','/index.html','/offline.html','/styles.css?v=22.4','/app.js?v=22.4','/manifest.webmanifest','/icon.svg','/icon-192.png','/icon-512.png','/gcash-qr.png','/gotyme-qr.png'];
